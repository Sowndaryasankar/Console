package com.zsgs.chat.repository;
...
public class ChatRepository {
	...
	private void initialSetup() {
		allUser.add(new User(1, "sowndarya", "1729", "Sowndarya", "sowndarya@gmail.com"));
		allUser.add(new User(2, "priya", "priya", "bharathapriya", "priya@gmail.com"));
		allMessages.add(new Message(1, "how are you", 1, 2, "sowndarya", "priya",LocalDateTime.now()));
		allMessages.add(new Message(2, "I am fine", 2, 1, "priya", "sowndarya",LocalDateTime.now()));
